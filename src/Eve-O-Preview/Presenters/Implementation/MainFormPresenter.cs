...
namespace EveOPreview.Presenters
{
	public class MainFormPresenter : Presenter<IMainFormView>, IMainFormPresenter
	{
		...
		private void LoadApplicationSettings()
		{
			...
			this.View.RestrictCycleHotkeysToActiveClients = this._configuration.RestrictCycleHotkeysToActiveClients;
		...
		private async void SaveApplicationSettings()
		{
			...
			this._configuration.RestrictCycleHotkeysToActiveClients = this.View.RestrictCycleHotkeysToActiveClients;
